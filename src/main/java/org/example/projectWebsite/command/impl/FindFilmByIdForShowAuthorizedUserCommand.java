...
public class FindFilmByIdForShowAuthorizedUserCommand implements Command {
    ...
    public CommandResult execute(HttpServletRequest request) throws CommandException {
        ...
        String page = PageManager.getPageURI(PageMappingConstant.FIND_FILM_BY_ID_FOR_SHOW_AUTHORIZED_USER);
