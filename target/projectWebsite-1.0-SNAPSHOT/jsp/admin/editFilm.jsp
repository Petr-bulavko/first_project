...
<form method="post" action="/film/edit">
    ...
    <label>Year</label><br>
    <select name="filmYear" value="${film.filmYear}" required>
    ...
    <select name="filmGenre" value="${film.filmGenre}" required>
    ...
    <select name="filmCountry" value="${film.filmCountry}" required>
    ...
    <textarea inputmode="text" name="description" style="width: 624px; height: 200px;" required>${film.description}</textarea><br><br>
